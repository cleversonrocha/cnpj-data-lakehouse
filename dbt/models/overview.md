...
|---|---|---|
| Fato | `fact_estabelecimentos` | Estabelecimentos (matriz/filiais) |
| Dimensão | `dim_cadastro` | Dados cadastrais |
| Ponte | `bridge_estabelecimentos_cnaes` | Resolve relacionamento muitos para muitos com dim_cnaes |
| Dimensão | `dim_cnaes` | Atividades econômicas dos estabelecimentos |
| Dimensão | `dim_localidades` | Localização geográfica dos estabelecimentos |
| Dimensão | `dim_naturezas_juridicas` | Natureza Jurídica das empresas |
| Dimensão | `dim_situacoes` | Identificação Matriz/Filial, Situação Cadastral e Especial dos estabelecimentos |
| Ponte | `bridge_estabelecimentos_socios` | Resolve relacionamentos muitos para muitos com dim_socios |
| Dimensão | `dim_socios` | Histórico societário das empresas |
| Dimensão | `dim_tempo_inicio_atividades` | Calendário com datas de início das atividades dos estabelecimentos |
| Dimensão | `dim_tempo_situacoes_cadastrais` | Calendário com datas das situações cadastrais dos estabelecimentos |
| Dimensão | `dim_tempo_situacoes_especiais` | Calendário com datas das situações especiais dos estabelecimentos |
| Agregação | `agg_fact_estabelecimentos` | Pré-agregação com tipos dos estabelecimentos, situações cadastrais, portes por início da atividade, situação, localização e natureza jurídica dos estabelecimentos  |
| Agregação | `agg_fact_estabelecimentos_cnaes` | Pré-agregação com as atividades econômicas dos estabelecimentos, por data de início da atividade, situações, localização e tipo do CNAE |
